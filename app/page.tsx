...
export default function LoginForm() {
  return (
    <main className="h-screen  bg-gradient-to-b from-purple-100 to-red-100 min-h-screen">
      <div className="h-full flex flex-col justify-between container relative m-0 mx-auto py-8 md:px-8">
        <div className="max-width flex items-center justify-center lg:justify-between">
          <Link className="flex items-center gap-1" href="/loggedin">
            <Image
              src={todoai}
              alt="logo"
              className="object-contain h-20 w-36 md:h-16 md:w-28 mix-blend-multiply"
            />
        ...
        <div className="w-full px-4 pt md:px-4 lg:px-8 xl:px-10 2xl:px-0">
          <div className=" absolute top-[-30px] left-0 flex h-full w-full flex-col items-center justify-center gap-5">
            <span
              rel="noreferrer"
...
always one step ahead.
        ...
        <footer className=" w-full flex flex-col items-center my-0 mx-auto justify-between space-y-3 border-t space-x-4 text-center sm:flex-row md:text-lg">
          <div className="text-base">
          Created by Zakariae with ❤️, © 2025. All rights reserved.
          </div>
...
function GoogleSignInButton() {
  ...
  return (
    <button
      disabled={pending}
      type="submit"
      className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-red-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
    >
      <span
        className={clsx(
