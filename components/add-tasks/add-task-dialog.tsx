...
import { getIncompleteSubTodos, getCompleteSubTodos, checkSubTodo, uncheckSubTodo } from "@/actions/subtodos"; // Import your server actions
...
export default function AddTaskDialog({ data }: { data: any }) {
  ...
  const [inCompletedSubtodosByProject, setInCompletedSubtodosByProject] = useState<any[]>([]);
  const [completedSubtodosByProject, setCompletedSubtodosByProject] = useState<any[]>([]);
